set moduleName toGray_AXIvideo2Mat
...
set isOneStateSeq 0
set C_modelName toGray_AXIvideo2Mat
set C_modelType { void 0 }
set C_modelArgList { 
	{ AXI_video_strm_V_data_V int 24 regular {axi_s 0 volatile  { IN_STREAM data } }  }
	{ AXI_video_strm_V_keep_V int 3 regular {axi_s 0 volatile  { IN_STREAM keep } }  }
	{ AXI_video_strm_V_strb_V int 3 regular {axi_s 0 volatile  { IN_STREAM strb } }  }
	{ AXI_video_strm_V_user_V int 1 regular {axi_s 0 volatile  { IN_STREAM user } }  }
	{ AXI_video_strm_V_last_V int 1 regular {axi_s 0 volatile  { IN_STREAM last } }  }
	{ AXI_video_strm_V_id_V int 1 regular {axi_s 0 volatile  { IN_STREAM id } }  }
	{ AXI_video_strm_V_dest_V int 1 regular {axi_s 0 volatile  { IN_STREAM dest } }  }
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "IN_STREAM_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "AXI_video_strm_V_data_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_keep_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TSTRB", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "AXI_video_strm_V_strb_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TUSER", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_user_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TLAST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_last_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TID", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_id_V", "role": "default" }} , 
 	{ "name": "IN_STREAM_TDEST", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "AXI_video_strm_V_dest_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	AXI_video_strm_V_data_V { axis {  { IN_STREAM_TDATA in_data 0 24 }  { IN_STREAM_TVALID in_vld 0 1 } } }
	AXI_video_strm_V_keep_V { axis {  { IN_STREAM_TKEEP in_data 0 3 } } }
	AXI_video_strm_V_strb_V { axis {  { IN_STREAM_TSTRB in_data 0 3 } } }
	AXI_video_strm_V_user_V { axis {  { IN_STREAM_TUSER in_data 0 1 } } }
	AXI_video_strm_V_last_V { axis {  { IN_STREAM_TLAST in_data 0 1 } } }
	AXI_video_strm_V_id_V { axis {  { IN_STREAM_TID in_data 0 1 } } }
	AXI_video_strm_V_dest_V { axis {  { IN_STREAM_TREADY in_acc 1 1 }  { IN_STREAM_TDEST in_data 0 1 } } }
